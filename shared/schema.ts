...
export const fortunetellerProfiles = pgTable("fortuneteller_profiles", {
  ...
  genre: varchar("genre", { length: 20 }).notNull().default(""),
...
export const querentProfiles = pgTable("querent_profiles", {
  ...
  partner2Name: varchar("partner2_name", { length: 20 }).notNull().default(""),
  partner2Birthdate: varchar("partner2_birthdate", { length: 10 }).notNull().default(""),
  partner2ZodiacSign: varchar("partner2_zodiac_sign", { length: 10 }).notNull().default(""),
  partner2Birthplace: varchar("partner2_birthplace", { length: 50 }).notNull().default(""),
  partner2Birthtime: varchar("partner2_birthtime", { length: 5 }).notNull().default(""),
